...
// COPY MEMORY INTERFACE BELOW.
ipx::associate_bus_interfaces -busif m_axi_insert_memory_name_here -clock ap_clk $core
// COPY MEMORY INTERFACE ABOVE.
...
// COPY MEMORY INTERFACE BELOW.
set reg      [::ipx::add_register -quiet "insert_memory_name_here_addr" $addr_block]
  set_property address_offset insert_memory_offset_here $reg
  set_property size           64    $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg]
  set_property value m_axi_insert_memory_name_here $regparam
// COPY MEMORY INTERFACE ABOVE.
